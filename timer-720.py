...
app = App(title="Lockpick Village Timer", width=1280, height=720, layout="grid")
app.columnconfigure(0, minsize=1280, pad=0)
app.rowconfigure(0, pad=5)
app.rowconfigure(1, pad=50)
...
box.columnconfigure(0, pad=50)
box.columnconfigure(1, pad=50)
box.rowconfigure(0, pad=10)
box.rowconfigure(1, pad=50)
box.rowconfigure(2, pad=10)
box.rowconfigure(3, pad=40)
